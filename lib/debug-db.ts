...
const debugDatabase = async () => {
  try {
    ...
    const { data: commentStructure, error: commentStructureError } = await supabase
      .rpc('exec_sql', { 
        sql_string: `
    ...
    const { data: commentPolicies, error: commentPoliciesError } = await supabase
      .rpc('exec_sql', { 
        sql_string: `
    ...
    const { data: commentRls, error: commentRlsError } = await supabase
      .rpc('exec_sql', { 
        sql_string: `
