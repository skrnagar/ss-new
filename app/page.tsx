            ...
            <div>
              ...
              <div className="flex flex-col w-full ">
                ...
                <div className="mt-6 flex flex-row space-x-3">
                  <Button variant="outline" onClick={() => window.location.href = '/auth/login?provider=google'} className="flex-1 flex items-center justify-center bg-white py-3 px-4 rounded-lg w-full hover:bg-gray-100 transition-colors h-auto">
                  ...
                  <Button variant="outline" onClick={() => window.location.href = '/auth/login?provider=linkedin'} className="flex-1 flex items-center justify-center bg-[#0077B5] py-3 px-4 rounded-lg w-full text-white hover:bg-[#0077B5]/90 transition-colors h-auto">
