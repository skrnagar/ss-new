    ...
    <div className="container py-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Connect with ESG and EHS professionals in specialized groups</p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center border rounded-md p-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-1">Discussions on evolving ESG reporting standards and frameworks</p>
                <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                  <div className="flex items-center space-x-1">
                    <Users className="h-3 w-3" />
